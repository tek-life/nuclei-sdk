...
void dwc3_maximum_speed(void)
{
	struct dwc3 *dwc = NULL;

	list_for_each_entry(dwc, &dwc3_list, list) {
		pr_err("xxx dwc->speed:%d dwc->maximum_speed:%d\n", dwc->speed, dwc->maximum_speed);
		break;
	}
}
...
int dwc3_uboot_init(struct dwc3_device *dwc3_dev)
{
	...
	pr_err("xxx dwc->maximunm_speed:%d\n", dwc->maximum_speed);
	...
	pr_info("xxx dwc->maximum_speed:%d\n", dwc->maximum_speed);
