...
#endif
#ifdef GENERATOR_FILE
extern int riscv_xxl_subext;
#else
  int x_riscv_xxl_subext;
#define riscv_xxl_subext global_options.x_riscv_xxl_subext
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_xxlvqmacc_subext;
#else
  int x_riscv_xxlvqmacc_subext;
#define riscv_xxlvqmacc_subext global_options.x_riscv_xxlvqmacc_subext
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_mautovec_dsp;
#else
  int x_riscv_mautovec_dsp;
#define riscv_mautovec_dsp global_options.x_riscv_mautovec_dsp
#endif
#ifdef GENERATOR_FILE
...
#define MASK_XXLFBF (1U << 0)
#define MASK_XXLVFBF (1U << 1)
#define MASK_XXLVQMACC (1U << 0)
...
#define TARGET_XXLFBF ((riscv_xxl_subext & MASK_XXLFBF) != 0)
#define TARGET_XXLFBF_P(riscv_xxl_subext) (((riscv_xxl_subext) & MASK_XXLFBF) != 0)
#define TARGET_XXLFBF_OPTS_P(opts) (((opts->x_riscv_xxl_subext) & MASK_XXLFBF) != 0)
#define TARGET_XXLVFBF ((riscv_xxl_subext & MASK_XXLVFBF) != 0)
#define TARGET_XXLVFBF_P(riscv_xxl_subext) (((riscv_xxl_subext) & MASK_XXLVFBF) != 0)
#define TARGET_XXLVFBF_OPTS_P(opts) (((opts->x_riscv_xxl_subext) & MASK_XXLVFBF) != 0)
#define TARGET_XXLVQMACC ((riscv_xxlvqmacc_subext & MASK_XXLVQMACC) != 0)
#define TARGET_XXLVQMACC_P(riscv_xxlvqmacc_subext) (((riscv_xxlvqmacc_subext) & MASK_XXLVQMACC) != 0)
#define TARGET_XXLVQMACC_OPTS_P(opts) (((opts->x_riscv_xxlvqmacc_subext) & MASK_XXLVQMACC) != 0)
...
#define TARGET_ZCLSD ((riscv_zilsd_subext & MASK_ZCLSD) != 0)
#define TARGET_ZCLSD_P(riscv_zilsd_subext) (((riscv_zilsd_subext) & MASK_ZCLSD) != 0)
#define TARGET_ZCLSD_OPTS_P(opts) (((opts->x_riscv_zilsd_subext) & MASK_ZCLSD) != 0)
...
enum opt_code
{
  ...
  OPT_list = 1958,                           /* -list */
  OPT_mabi_ = 1959,                          /* -mabi= */
  OPT_madjust_lmul_cost = 1960,              /* -madjust-lmul-cost */
  OPT_malign_data_ = 1961,                   /* -malign-data= */
  OPT_march_ = 1962,                         /* -march= */
  OPT_march_help = 1963,                     /* -march=help */
  OPT_mautovec_dsp = 1964,                   /* -mautovec-dsp */
  OPT_mautovec_segment = 1965,               /* -mautovec-segment */
  OPT_mbig_endian = 1966,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1967,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1968,                       /* -mcmodel= */
  OPT_mcpu_ = 1969,                          /* -mcpu= */
  OPT_mcsr_check = 1970,                     /* -mcsr-check */
  OPT_mdiv = 1971,                           /* -mdiv */
  OPT_mexplicit_relocs = 1972,               /* -mexplicit-relocs */
  OPT_mfdiv = 1973,                          /* -mfdiv */
  OPT_mfence_tso = 1974,                     /* -mfence-tso */
  OPT_minline_atomics = 1975,                /* -minline-atomics */
  OPT_minline_strcmp = 1976,                 /* -minline-strcmp */
  OPT_minline_strlen = 1977,                 /* -minline-strlen */
  OPT_minline_strncmp = 1978,                /* -minline-strncmp */
  OPT_misa_spec_ = 1979,                     /* -misa-spec= */
  OPT_mlittle_endian = 1980,                 /* -mlittle-endian */
  OPT_mmovcc = 1981,                         /* -mmovcc */
  OPT_momit_leaf_frame_pointer = 1982,       /* -momit-leaf-frame-pointer */
  /* OPT_mplt = 1983, */                     /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1984,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1985,                         /* -mrelax */
  OPT_mriscv_attribute = 1986,               /* -mriscv-attribute */
  OPT_mrvv_max_lmul_ = 1987,                 /* -mrvv-max-lmul= */
  OPT_mrvv_vector_bits_ = 1988,              /* -mrvv-vector-bits= */
  OPT_msave_restore = 1989,                  /* -msave-restore */
  /* OPT_mscalar_strict_align = 1990, */     /* -mscalar-strict-align */
  ...
  OPT_mvector_strict_align = 2000,           /* -mvector-strict-align */
  OPT_n = 2001,                              /* -n */
