...
#if  defined(__riscv_xxlcz)
  #define __SEGGER_RTL_CORE_HAS_XLFL1                  1
#else
  #define __SEGGER_RTL_CORE_HAS_XLFL1                  0
#endif

#if  defined(__riscv_xxlcz)
  #define __SEGGER_RTL_CORE_HAS_XLFF1                  1
#else
  #define __SEGGER_RTL_CORE_HAS_XLFF1                  0
#endif

#if  defined(__riscv_zbb)
  #define __SEGGER_RTL_CORE_HAS_CTZ                    1
#else
  #define __SEGGER_RTL_CORE_HAS_CTZ                    0
#endif

#if  defined(__riscv_zbb)
  #define __SEGGER_RTL_CORE_HAS_FFS                    1
#else
  #define __SEGGER_RTL_CORE_HAS_FFS                    0
#endif
...
#elif __SEGGER_RTL_CORE_HAS_XLFF1
  #define __SEGGER_RTL_CLZ_U32(X)               ((X == 0) ? 32 : (31 - __builtin_xxlcz_ff1(X)))
#endif

//
// Configuration of CTZ support.
//
#if __SEGGER_RTL_CORE_HAS_CTZ
  #define __SEGGER_RTL_CTZ_U32(X)               __builtin_ctz(X)
#elif __SEGGER_RTL_CORE_HAS_XLFL1
  #define __SEGGER_RTL_CTZ_U32(X)               ((X == 0) ? 0xffffffff : __builtin_xxlcz_fl1(X))
#endif

//
// Configuration of FFS support.
//
#if __SEGGER_RTL_CORE_HAS_FFS
  #define __SEGGER_RTL_FFS_U32(X)               __builtin_ffs(X)
#elif __SEGGER_RTL_CORE_HAS_XLFL1
  #define __SEGGER_RTL_FFS_U32(X)               ((X == 0) ? 0 : (__builtin_xxlcz_fl1(X) + 1))
#endif
