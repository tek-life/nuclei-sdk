...
// NUCLEI Optimize Config
#define   NUCLEI_OPTIMIZE_SPEED
#define   NUCLEI_OPTIMIZE_BALANCED
#define   NUCLEI_OPTIMIZE_CODESIZE
#define   NUCLEI_OPTIMIZE_FAST_TO_BALANCED

#ifdef    NUCLEI_OPTIMIZE_SPEED
  #define NUCLEI_OPTIMIZE_SPEED_MEMSET          1
  #define NUCLEI_OPTIMIZE_SPEED_MEMCPY          1
  #define NUCLEI_OPTIMIZE_SPEED_STRCPY          1
  #define NUCLEI_OPTIMIZE_SPEED_STRLEN          1
  #define NUCLEI_OPTIMIZE_SPEED_STRCMP          1
  #define NUCLEI_OPTIMIZE_SPEED_STRCAT          1
#else
  #define NUCLEI_OPTIMIZE_SPEED_MEMSET          0
  #define NUCLEI_OPTIMIZE_SPEED_MEMCPY          0
  #define NUCLEI_OPTIMIZE_SPEED_STRCPY          0
  #define NUCLEI_OPTIMIZE_SPEED_STRLEN          0
  #define NUCLEI_OPTIMIZE_SPEED_STRCMP          0
  #define NUCLEI_OPTIMIZE_SPEED_STRCAT          0
#endif
#ifdef    NUCLEI_OPTIMIZE_BALANCED
  #define NUCLEI_OPTIMIZE_BALANCED_STRRCHR      1
#else
  #define NUCLEI_OPTIMIZE_BALANCED_STRRCHR      0
#endif
#ifdef    NUCLEI_OPTIMIZE_FAST_TO_BALANCED
  #define NUCLEI_OPTIMIZE_FAST_TO_BALANCED_STRNCHR  1
  #define NUCLEI_OPTIMIZE_FAST_TO_BALANCED_STRNCMP  1
#else
  #define NUCLEI_OPTIMIZE_FAST_TO_BALANCED_STRNCHR  0
  #define NUCLEI_OPTIMIZE_FAST_TO_BALANCED_STRNCMP  0
#endif
